...
export function CsvImport() {
  ...
  return (
    <section className="rounded-lg border border-neutral-200 p-4">
      <h2 className="text-lg font-semibold text-neutral-900">CSV import</h2>
      ...
      <label className="mt-3 inline-flex min-h-12 cursor-pointer items-center rounded-md border border-neutral-300 px-4 text-sm font-medium">
      ...
      {report && (
        <div className="mt-3 text-sm">
          <p className="rounded-md border border-neutral-200 bg-neutral-50 p-3 text-neutral-700">
              ...
              <table className="w-full min-w-[28rem]">
                ...
                <tbody>
                  {report.rejects.map((reject) => (
                    <tr key={reject.line} className="border-t border-neutral-200 align-top">
